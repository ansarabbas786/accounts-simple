...
<main class="container">
    <div class="row shortcuts">
        ...
        <div class="custom_container clearfix hidden-xs">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                ...
                <a href="invoice.php" class="text-center special">
                    <div><i class="fa fa-file-text-o"> </i></div>
                    NEW INVOICE</a>
            </div>

            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                <a href="#new_expense_modal" data-toggle="modal" class="text-center special">
                    <div><i class="fa fa-calculator"></i></div>
                    NEW EXPENSE</a>
            </div>

            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                <a href="#new_payment_modal" data-toggle="modal" class="text-center special">
                    <div><i class="fa fa-credit-card-alt"></i></div>
                    NEW PAYMENT</a>
            </div>

            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                <a href="#new_receipt_modal" data-toggle="modal" class="text-center special">
                    <div><i class="fa fa-university"> </i></div>
                    NEW RECEIPT</a>
            </div>

            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                <a href="#payroll_run_modal" data-toggle="modal" class="text-center special">
        ...
        <ul class="nav nav-pills nav-justified hidden-sm hidden-md hidden-lg">
            ...
            <li><a href="#new_expense_modal" data-toggle="modal"> <span class="fa fa-calculator"></span>&nbsp;&nbsp;NEW
                    EXPENSE</a></li>
            <li><a href="#new_payment_modal" data-toggle="modal"><span class="fa fa-credit-card-alt"></span>&nbsp;&nbsp;NEW
                    PAYMENT</a></li>
            <li><a href="#new_receipt_modal" data-toggle="modal"><span class="fa fa-university"></span>&nbsp;&nbsp;NEW
                    RECEIPT</a></li>
            <li><a href="#payroll_run_modal" data-toggle="modal"><span class="fa fa-usd"></span>&nbsp;&nbsp;PAYROLL RUN</a>
            </li>
        </ul>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6">
            <div class="table-responsive">
                <table class="table">
                    <caption class="text-center"><span class="fa fa-line-chart"></span>&nbsp;&nbsp;&nbsp;Profit &amp;
                        Loss
                    </caption>
                    <thead>
                    <tr>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="bank_value">
                                    ...
                                    <input type="text" class="form-control custom_hidden" id="bank_dropdown"
                                           name="bank_dropdown">
                                </td>
                                ...
                                <td class="date_value">
                                    ...
                                    <input type="text" class="form-control date_input" name="enter_date"
                                ...
                                <td class="paid_to_value">
                                    ...
                                    <input type="text" class="form-control custom_hidden" id="paid_to_dropdown"
                                           name="paid_to_dropdown">
                                </td>
                                ...
                                <td class="analysis_value">
                                    ...
                                    <input type="text" class="form-control custom_hidden" id="analysis_dropdown"
                                           name="analysis_dropdown">
                                </td>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="bank_from_value">
                                    ...
                                    <input type="text" class="form-control custom_hidden" id="bank_from_dropdown"
                                           name="bank_from_dropdown">
                                </td>
                                ...
                                <td class="to_from_value">
                                    ...
                                    <input type="text" class="form-control custom_hidden" id="to_from_dropdown"
                                           name="to_from_dropdown">
                                </td>
